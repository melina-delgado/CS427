...
namespace todo
{
  ...
  public:
    /**
     * Creates an uncompleted task with a zero time estimate and empty
     * description.  (Needed so we can have arrays of Tasks w/o bothering
     * with array initializers; when we start with STL we can replace
     * our arrays with vectors, which does away with the need to have
