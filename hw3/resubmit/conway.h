...
namespace cs427_527
{
   ...
   * Outputs the given board to the given stream in the format read by the version of the constructor that reads from an input stream (without the first line giving the size of the board)*/
  ostream& operator<<(ostream&, const Conway&);
}
